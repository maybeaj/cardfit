...
| FE-01-01 | 모바일 우선 랜딩·웰컴 화면 구성 | FE-01 | UI-011 | Step 2 | DS-01-02·04 |
| FE-01-02 | 마이데이터 이용 동의 안내 화면 구성 | FE-01 | UI-012 | Step 2 | DS-01-04 |
| FE-01-03 | 예시 데이터 조회 완료 상태 구현 | FE-01 | AC-011 | Step 2 | FX-01-03·FE-01-02 |
| FE-01-04 | 현재 카드와 혜택 확인 화면 구현 | FE-01 | UI-001·AC-012 | Step 2 | DS-01-06·FX-01-03 |
| FE-01-05 | 현재 카드 확인·미래 CTA 구현 | FE-01 | UI-001 | Step 2 | FE-01-04 |
...
| UI-04 랜딩·마이데이터 이용 동의 | FE-01-01·02·03 |
| UI-05 현재 카드와 혜택 확인 | FE-01-04 |
| UI-06 미래지출 진입 | FE-01-05 |
